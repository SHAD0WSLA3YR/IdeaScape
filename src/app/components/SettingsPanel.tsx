    ...
    <>
      ...
      <div className="max-h-[70vh] overflow-y-auto pr-1">
          <div className="space-y-6">
            ...
            <div>
              <h3 className="font-medium text-base mb-3 flex items-center gap-2">
                <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center dark:bg-orange-900/40">
              ...
              <div className="space-y-3 ml-8">
                ...
                <div className="rounded-md border border-orange-200/70 bg-orange-50/70 p-3 text-xs dark:border-orange-800/60 dark:bg-orange-950/20">
            ...
            <div>
              ...
              <div className="space-y-2 ml-8">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-600 dark:text-gray-400">Theme Active:</span>
                  <Badge variant="outline" className="text-xs">
                    {settings.theme === 'system' 
