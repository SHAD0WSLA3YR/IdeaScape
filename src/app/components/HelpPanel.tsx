...
export function HelpPanel() {
  ...
  return (
    <>
      ...
      <div className="absolute bottom-4 left-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-lg text-sm max-w-xs help-panel" style={{ zIndex: 50 }}>
        <button
